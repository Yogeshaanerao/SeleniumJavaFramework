...
public class GridTest1 {
	 ...
	 * 
	 * console URL : http://192.168.0.132:4444/wd/hub/
	 * 
	 ...
	 * Node URL (ff+chrome)
	 * java -Dwebdriver.chrome.driver="D:\RadicalSoftware\WEB BROWSER\chromedriver_win32_B39\chromedriver.exe" -Dwebdriver.gecko.driver="D:\Training\TrainingContent\SeleniumJars_Software\geckodriver_64\geckodriver.exe" -jar selenium-server-standalone-3.141.59.jar -role node -hub http://192.168.0.132:4444/wd/hub/ -browser "browserName=firefox,version=ANY,platform=WINDOWS,maxInstances=5" -browser "browserName=chrome,version=ANY,platform=WINDOWS,maxInstances=5" -maxSession 5
	 * 
